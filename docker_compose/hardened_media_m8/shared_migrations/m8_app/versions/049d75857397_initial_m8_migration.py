...
Revision ID: 049d75857397
Revises:
Create Date: 2026-05-27 09:57:52.035913
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_app_category_owner_id"), "app_category", ["owner_id"], unique=False
    )
