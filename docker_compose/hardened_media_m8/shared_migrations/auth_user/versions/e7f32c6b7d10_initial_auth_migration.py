...
Revision ID: e7f32c6b7d10
Revises:
Create Date: 2026-05-27 09:57:48.584028
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["api_key_id"], ["auth_api_key.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["auth_user.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_index(
        op.f("ix_auth_rate_limit_api_key_id"),
        "auth_rate_limit",
        ["api_key_id"],
        unique=False,
    )
