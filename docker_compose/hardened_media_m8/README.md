...
| media_service | `tepochtli/media-service-m8:0.0.11` | `/media` via Traefik |
| media_service_worker | `tepochtli/media-service-m8:0.0.11` (arq command override) | internal — no port; lifecycle/outbox crons |
