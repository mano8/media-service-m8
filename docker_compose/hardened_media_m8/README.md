...
| media_service | `tepochtli/media-service-m8:2.3.0` | `/media` via Traefik |
| media_service_worker | `tepochtli/media-service-m8:2.3.0` (arq command override) | internal — no port; lifecycle/outbox crons |
| media_worker | `tepochtli/media-worker-m8:0.5.0` | internal — enqueue-driven (scan + variants) |
