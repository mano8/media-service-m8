...
| [hardened_media_m8](hardened_media_m8/) | `tepochtli/media-service-m8:2.1.0` | published images | none (internal only) | Reference deployment / production-shaped posture |
