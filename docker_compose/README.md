...
| [hardened_media_m8](hardened_media_m8/) | `tepochtli/media-service-m8:0.0.11` | published images | none (internal only) | Reference deployment / production-shaped posture |
